...
class CogEnvDecoder:
    def __init__(self, size=(400, 400), train=True, allow_multiple_obs=True):
        if train:
    ...
    def _Getimg(imgData):
        ...
        if img_length > 0:
            ...
            gray0=np.zeros((500,500),dtype=np.uint8)
            return gray0
    ...
    def _CollCondtion(self, data):
        coll_time = data[80024]
        cont_coll_time = data[80025]
